...
function updateTextElements() {
    ...
    if (loginTitle) loginTitle.innerHTML = `🔑 ${lang.welcomeBack}`;
    
    const registerTitle = document.querySelector('#registerForm h2');
    if (registerTitle) registerTitle.innerHTML = `👤 ${lang.createAccount}`;
    
    const resetTitle = document.querySelector('#resetForm h2');
    if (resetTitle) resetTitle.innerHTML = `🔑 ${lang.resetPassword}`;
...
function setupAppEvents() {
    ...
    if (aiGenerateBtn) {
        aiGenerateBtn.addEventListener('click', async () => {
            ...
            aiGenerateBtn.innerHTML = '<span>✨ Generate Email</span>';
